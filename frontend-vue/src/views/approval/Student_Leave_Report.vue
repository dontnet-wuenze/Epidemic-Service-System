    ...
    <div class="container">
      ...
      <div class="scroll-container-form">
        <el-form ref="StuLeaveForm" :label-position="labelPosition" :model="form" label-width="auto" :rules="rules">
          ...
          <!-- 动态添加组件，省份城市区县应当为选项，待完成 -->
          <el-form-item label="离校前往目的地" prop="destination">
            <div style="border: solid 1px #DCDFE6;border-radius: 4px;box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04)">
              <el-row>
                <el-col span="6">
                  <el-form-item label="省份">
                    <el-input v-model="form.province_1"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col span="6">
                  <el-form-item label="城市">
                    <el-input v-model="form.city_1"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col span="6">
                  <el-form-item label="区县">
                    <el-input v-model="form.district_1"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
