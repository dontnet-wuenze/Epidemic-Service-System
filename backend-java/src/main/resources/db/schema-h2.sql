...
(
    ...
    appDate DATE NULL DEFAULT NULL COMMENT '预约日期',
    appTime INT NULL DEFAULT NULL COMMENT '预约时间(1/2/3/4代表四个时间段)',
    appAddress VARCHAR(50) NULL DEFAULT NULL COMMENT '预约检查点',
